...
check = [
    '--color-header-bg', '--color-fg-on-emphasis', '--color-btn-primary-text',

    '--color-success-fg', '--color-attention-fg', '--color-severe-fg', '--color-danger-fg', '--color-done-fg',
    '--color-sponsors-fg', '--color-success-emphasis', '--color-attention-emphasis', '--color-severe-emphasis',
    '--color-danger-emphasis', '--color-done-emphasis', '--color-sponsors-emphasis'
]

sCheck = set(check)
print(len(sCheck))
print(sCheck.issubset(s2))
